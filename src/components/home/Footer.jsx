            ...
            <div  style={{width: '80%', margin: 'auto'}}>
                <div className='ft' >
                    <div className='ant-col ant-col-xs-24 ant-col-lg-12 ant-col-xl-6' style={{ paddingLeft: '12px', paddingRight: '12px' }}>
                        <div className='footer-box'>
                            ...
                            <div>
                                <img src="../img/dmca.2593d9ecf1c982e3c3a2.png"style={{width:"120px",height:"30px"}} alt="" />
                            </div>
                        </div>
                    </div>
                ...
                <div className='footer-end'>
                    ...
                    <div className='footer-tags-lnk'>
                        <a href="https://www.facebook.com/rikkeiacademy"><i className="fa-brands fa-facebook"></i></a>
                        <a href="https://www.youtube.com/c/RikkeiAcademy%C4%90%E1%BB%83n%C3%B4ngd%C3%A2nbi%E1%BA%BFtcode"><i className="fa-brands fa-youtube"></i></a>
                        <a href="https://www.tiktok.com/@rikkeiacademy?lang=vi-VN"><i className="fa-brands fa-tiktok"></i></a>
                    </div>
                </div>
            </div>
        </div>
